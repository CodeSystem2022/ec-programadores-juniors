    ...
    return (
        <>
            <FullWidthLayout>
                ...
                <div className='mx-2'>
                    <p className='txt'>En SportBlend fusionamos nuestra pasión por el deporte y la moda para ofrecerte una experiencia única en la compra de ropa deportiva moderna. </p>
